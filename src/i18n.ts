...
export const copy = {
  ...
  tweaks: {
    ...
    reduceMotion: '减少动效',
    reduceMotionHint: '缩短搜索聚焦与力导向动画',
    showStrip: '显示底栏',
    showStripHint: '常用与最近访问书签条',
    openInNewTab: '新标签页打开',
    openInNewTabHint: '关闭时在当前标签跳转',
    searchProvider: '默认搜索目标',
    searchProviderHint: '图搜索没有书签匹配时，Enter 打开的搜索或 AI 提问入口',
    customSearchName: '显示名称',
    customSearchUrl: '链接模板，使用 {query} 插入搜索词',
    searchKindSearch: '搜索',
    searchKindAsk: '提问',
    bgImageTitle: '自定义背景图',
    bgImageUpload: '上传图片',
